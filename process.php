...
$my_email = "info@firstplacephotography.com";
...
$from_email = "info@firstplacephotography.com";
...
$field_order_keys = array('first_name','last_name','phone','email','address','city','state','zip','comments');
