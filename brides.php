...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <ul id="wedding_nav">
      ...
      <li><a class="selected" href="brides.php">Brides</a></li>
      <!--<li><a href="digital.php">Digital</a></li>-->
    </ul>
    <div id="flash">
      <div id="flashContent"> </div>
      <script type="text/javascript">
		var so = new SWFObject("flash/brides.swf", "mymovie", "802", "582", "9", "#000");
		so.useExpressInstall('flash/expressinstall.swf');
		so.addParam("quality", "high");
		so.addParam("wmode", "transparent");
		so.addParam("salign", "t");
		//so.addParame("pagename", "\"flash/brides/images.xml\"");
